...
function CreatePost() {
	const schema = yup.object({
		title: yup
			.string()
			.required('O post precisa do título')
			.max(20, 'O tamanho máximo do título é 20 caracteres'),
		body: yup
			.string()
			.required('Cade o texto, assim vazio não dá pra enviar né')
			.min(30, 'Tamanho mínimo de 30 caracteres'),
	})
